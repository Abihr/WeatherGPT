...
const OPTIONS = [
  {
    value: "off",
    label: "Don't Share",
    desc: "Friends won't see your location.",
  },
  {
    value: "approximate",
    label: "Approximate Location",
    desc: "Shows your general area, not the exact point.",
  },
          ...
          <label
            ...
            className={`flex items-start gap-3 p-3 rounded-xl2 border cursor-pointer transition-colors ${
              locationSharing === opt.value
                ...
                : "border-sky-100 hover:bg-sky-50/60"
            }`}
          >
            <input
              type="radio"
              ...
              checked={locationSharing === opt.value}
              onChange={() =>
                updateLocationSharing(opt.value)
              }
            />
